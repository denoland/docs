...
class PageIndexer {
  ...
  constructor(private rootUrl: URL, log: boolean = false) {
    this.log = log;
    this.indexQueue = [];
  ...
  public async extractPageLinks(pageUrl: URL, content: string) {
...
const baseUrlString = Deno.env.get("DOCS_ROOT") || "http://localhost:3000";
