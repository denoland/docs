 ...
 * @tags cli, deploy
 * @run --allow-env <url>
 * @resource {https://docs.deno.com/runtime/reference/node} Node.js / npm support in Deno
 * @resource {https://docs.deno.com/runtime/reference/node/#node_specifiers} node: specifiers
 * @group Basics
 *
