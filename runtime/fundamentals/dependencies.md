---
title: "Using and managing dependencies in Deno"
oldUrl:
...
Read more in [`deno add` reference](/runtime/reference/cli/add.md).

You can also remove depenedencies using `deno remove`:
...
Read more in [`deno remove` reference](/runtime/reference/cli/remove.md).
