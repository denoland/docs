...
Dependency tasks are in executed parallel, with the default parallel limit being
equal to the number of cores on your machine. To change this limit use the
