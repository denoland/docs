...
<span class="pl-en">assert</span>(<span class="pl-s">"I am truthy"</span>); <span class="pl-c">// Doesn't throw</span>
<span class="pl-en">assert</span>(<span class="pl-c1">false</span>); <span class="pl-c">// Throws `AssertionError`</span>
</code><button class="copyButton" data-copy="import { assert } from &quot;@std/assert&quot;;
