    ...
    <div>
      <div class="flex flex-col gap-4 mb-8">
        <p>
          ...
          command. You can enable sets of rules in <code>deno.json(c)</code> by adding their tags
          (e.g. <code>recommended</code>, <code>react</code>) to the <code>lint.rules.tags</code> array.
        </p>
        <input
          type="text"
          id="lint-rule-search"
