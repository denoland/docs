  ...
  if (!file) {
    ...
    return (
      <section class="feedback-form">
        <h2 class="form-header">Help us make these docs great!</h2>
        <div class="flex flex-col sm:flex-row gap-8">
          <div class="flex-1">
            <form aria-live="polite" id="feedback-form">
              <h3 class="form-section-header">Did you find what you needed?</h3>
              <p>
                We love your feedback! Let us know how we could make this page
                better.
              </p>
          ...
          <div class="flex-1">
            <h3 class="form-section-header">Make a contribution</h3>
            <p class="mb-1">
              Deno's docs are open source. See something that's wrong or
