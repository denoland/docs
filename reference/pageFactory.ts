...
factories.set(
  "moduleDoc",
  getPagesForModule as ReferenceDocumentFactoryFunction<DocNodeBase>,
);
factories.set(
  "namespace",
  getPagesForNamespace as ReferenceDocumentFactoryFunction<DocNodeBase>,
);
factories.set(
  "function",
  getPagesForFunction as ReferenceDocumentFactoryFunction<DocNodeBase>,
);
factories.set(
  "variable",
  getPagesForVariable as ReferenceDocumentFactoryFunction<DocNodeBase>,
);
factories.set(
  "enum",
  getPagesForNotImplemented as ReferenceDocumentFactoryFunction<DocNodeBase>,
);
factories.set(
  "class",
  getPagesForClass as ReferenceDocumentFactoryFunction<DocNodeBase>,
);
factories.set(
  "typeAlias",
  getPagesForTypeAlias as ReferenceDocumentFactoryFunction<DocNodeBase>,
);
factories.set(
  "interface",
  getPagesForInterface as ReferenceDocumentFactoryFunction<DocNodeBase>,
);
factories.set(
  "import",
  getPagesForImport as ReferenceDocumentFactoryFunction<DocNodeBase>,
);
