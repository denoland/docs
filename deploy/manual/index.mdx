...
We'll use the [`deployctl`](./deployctl.md) command line utility to deploy a local Deno script from your computer.

### Install Deno and `deployctl`

If you haven't already, you can [install the Deno runtime](/runtime/manual/getting_started/installation) using one of the commands below:
